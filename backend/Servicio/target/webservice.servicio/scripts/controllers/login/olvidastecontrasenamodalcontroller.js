/**
 * Created by Daniel jose on 20/02/2017.
 */
angular.module('webAppVtrackApp')
    .controller('olvidastecontrasenamodalcontroller', olvidastecontrasenamodalcontroller);


function olvidastecontrasenamodalcontroller ($scope, $element, title, close,$timeout,ServicioLogin) {
    ...
    $scope.accionBotonOk = function (){
        ...
        if (validarCorreo())
        {
            console.log('ya valide, ahora llamar serviciologin');
            ServicioLogin.olvidasteContrasena(view.correo)
                .then(function(data){
